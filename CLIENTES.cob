      ...
      ******************************************************************
       ...
       FILE-CONTROL.
           SELECT CLIENTES ASSIGN TO 'D:\projetocob\CLIENTES.DAT'
               ORGANIZATION IS INDEXED
               ACCESS MODE IS DYNAMIC
               FILE STATUS IS CLIENTES-STATUS
               RECORD KEY IS CLIENTES-CHAVE.

           SELECT RELATO ASSIGN TO 'D:\projetocob\RELATO.TXT'
       ...
       01 TELA.
           05 LIMPA-TELA.
               ...
               10 LINE 01 COLUMN 25 PIC X(20)
                    BACKGROUND-COLOR 1 FROM 'SISTEMA DE CLIENTES ' .
               10 LINE 02 COLUMN 01 PIC X(25) ERASE EOL
               BACKGROUND-COLOR 3 FROM WRK-MODULO.
       ...
       01 MENU.
           ...
           05 LINE 14 COLUMN 21 USING WRK-OPCAO.
       ...
       01 MOSTRA-ERRO.
           02 MSG-ERRO.
               ...
               BACKGROUND-COLOR 1 FROM WRK-MSGERRO.
           ...
           EVALUATE WRK-OPCAO
             ...
             WHEN OTHER
              IF WRK-OPCAO NOT EQUAL 'X'
                  DISPLAY 'ENTRE COM A OPCAO CORRETA' AT 1321
              END-IF
           END-EVALUATE.
           ...
           DISPLAY TELA.
             ...
             READ CLIENTES
                 ...
                 END-PERFORM
                   ...
                   MOVE WRK-QTREGISTROS TO RELATO-REG(17:05)
                 END-READ.
                   MOVE 'REGISTROS LIDOS' TO WRK-MSGERRO.
                   MOVE WRK-QTREGISTROS TO WRK-MSGERRO(17:05).
                     ACCEPT MOSTRA-ERRO.
